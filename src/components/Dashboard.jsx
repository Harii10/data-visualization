...
const piechartData = selectedName ? [
  ...
  return (
    <div className="ml-75">
      ...
      <div className="my-10 mx-12 p-5 shadow-lg rounded-xl border border-gray-300 bg-white">
        <LineGrapgh />
      </div>
      <div className="my-10 mx-12 p-5 shadow-lg rounded-xl border border-gray-300 bg-white">
          <Bchart/>
      ...
      <div className=" w-2/3 my-10 mx-12 shadow-lg rounded-xl border border-gray-300 bg-white">
        <Tables/>
      </div>
      <div className="flex flex-col gap-56 w-80 my-10 -mx-11 shadow-lg rounded-xl border border-gray-300 bg-white">
      <div>
      <SelectDropdown
